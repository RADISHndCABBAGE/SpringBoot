	...
	private DataSource buildDataSource(Map<String, Object> dsMap) {
		...
		try{
			...
			DataSourceBuilder factory = 
						DataSourceBuilder.create().driverClassName(driverClassName).url
						(url).username(username).password(password).type(dataSourceType);
...
//			排除已经设置的属性
	...
	public void registerBeanDefinitions(AnnotationMetadata importingClassMetadata,
		...
		// TODO Auto-generated method stub
		System.out.println("DynamicDataSourceRegisger.registerBeanDefinitions()");
